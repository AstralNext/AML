import 'package:aml/src/features/accounts/ui/device_code_login_dialog.dart';
...
class AccountStore {
  ...
  /// MSA login via OAuth2 Device Code flow (cross-platform).
  ...
  Future<bool> loginMicrosoft(BuildContext context) async {
    ...
    error.value = null;
    try {
      final account = await DeviceCodeLoginDialog.show(context);
