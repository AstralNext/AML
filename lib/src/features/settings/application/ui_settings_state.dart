...
class UiSettingsState {
  ...
  final downloadThreads = signal(defaultDownloadThreads);
  ...
  void _applySettings(UiSettings settings) {
    ...
    downloadThreads.value = parseDownloadThreads(settings.downloadThreads);
  ...
  void setDownloadThreads(int value) {
    final next = parseDownloadThreads(value);
    if (downloadThreads.value == next) return;
    downloadThreads.value = next;
  }
